...
<head>
    ...
    <title>{{ config('app.name', 'HR Assistance') }} - Sign In</title>
        ...
        <div class="w-full max-w-6xl">
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="space-y-8">
                    ...
                    <!-- Back to Home -->
                    <div class="pt-4">
                        <a href="{{ url('/') }}" class="inline-flex items-center gap-1.5 text-sm text-gray-400 hover:text-purple-400 transition-colors group">
