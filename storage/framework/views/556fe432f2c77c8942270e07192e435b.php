        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <div class="flex items-center gap-3">
                    <a href="<?php echo e(route('login')); ?>" class="hidden sm:inline-flex text-sm font-medium text-gray-400 hover:text-white transition-colors px-4 py-2">
                        Sign In
                    </a>
            ...
            <div class="mt-20 text-center" data-aos="fade-up">
                ...
                <div class="overflow-hidden">
                    <div class="flex marquee-track gap-16 items-center">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['Standard Bank', 'Discovery', 'MTN', 'Vodacom', 'Naspers', 'Shoprite', 'Old Mutual', 'Sasol']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div class="flex items-center gap-3 text-gray-500">
                                <div class="w-8 h-8 rounded-lg bg-gradient-to-br from-gray-600 to-gray-700 flex items-center justify-center text-xs font-bold text-gray-300">
                                    <?php echo e(substr($company, 0, 1)); ?>

                                </div>
                                <span class="text-lg font-semibold"><?php echo e($company); ?></span>
                            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="grid md:grid-cols-4 gap-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="<?php echo e(route('register')); ?>" class="text-sm text-gray-400 hover:text-purple-400 transition-colors">Get Started</a></li>
                    </ul>
                </div>
            ...
            <div class="mt-12 pt-8 border-t border-[#1C1C1E] flex flex-col md:flex-row items-center justify-between gap-4">
                <p class="text-sm text-gray-500">
                    &copy; <?php echo e(date('Y')); ?> HR Assistance. All rights reserved. Proudly South African.
                </p>
...
<?php /**PATH /home/u952164533/domains/green-alligator-418959.hostingersite.com/public_html/resources/views/landing.blade.php ENDPATH**/ ?>