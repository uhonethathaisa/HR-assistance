...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($file): ?>
            <div class="mt-4 flex items-center justify-between bg-[#1C1C1E] rounded-lg px-4 py-3">
                <div class="flex items-center space-x-3">
                    <svg class="w-5 h-5 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                    </svg>
                    <span class="text-white text-sm"><?php echo e($file->getClientOriginalName()); ?></span>
                    <span class="text-xs text-gray-400"><?php echo e(round($file->getSize() / 1024)); ?> KB</span>
                </div>
            ...
            <button wire:click="uploadAndParse"
                    wire:loading.attr="disabled"
                    class="mt-4 w-full bg-gradient-to-r from-purple-500 to-purple-700 hover:from-purple-600 hover:to-purple-800 text-white font-medium py-3 rounded-lg transition-all duration-300 shadow-lg shadow-purple-500/25 hover:shadow-purple-500/40">
                <span wire:loading.remove>🚀 Import with AI</span>
                <span wire:loading>Processing...</span>
            </button>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

        <!-- Upload Progress -->
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isUploading): ?>
            <div class="mt-4">
                <div class="flex items-center justify-between text-sm">
                    <span class="text-gray-400"><?php echo e($processingStatus); ?></span>
                    <span class="text-purple-400"><?php echo e($uploadProgress); ?>%</span>
                </div>
                <div class="w-full bg-[#1C1C1E] rounded-full h-2 mt-2 overflow-hidden">
                    <div class="bg-gradient-to-r from-purple-500 to-purple-700 h-2 rounded-full transition-all duration-300"
                         style="width: <?php echo e($uploadProgress); ?>%"></div>
                </div>
            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php /**PATH C:\Users\zee\Desktop\laravel-app\resources\views/livewire/work-history.blade.php ENDPATH**/ ?>