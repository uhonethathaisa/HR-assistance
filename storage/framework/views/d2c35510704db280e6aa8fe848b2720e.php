...
<head>
    ...
    <title><?php echo e(config('app.name', 'HR Assistance')); ?> - Professional CV Optimization & Cover Letter Service</title>
                        ...
                        <form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-4">
                            ...
                            <div>
                                ...
                                <input id="name" type="text" name="name" value="<?php echo e(old('name')); ?>" required autofocus
                                       ...
                                       class="w-full bg-[#1A1B2E] border border-[#2D3A4F] text-white rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <p class="text-center text-sm text-gray-400 mt-4">
                                Already registered?
                                <a href="<?php echo e(route('login')); ?>" class="text-purple-400 hover:text-purple-300 font-medium transition-colors">
                                    Sign in
                                </a>
                            </p>
...
<?php /**PATH C:\Users\zee\Desktop\laravel-app\resources\views/auth/register.blade.php ENDPATH**/ ?>